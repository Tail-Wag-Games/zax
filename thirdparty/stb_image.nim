...
proc load_from_file*(f: ptr FileHandle, x: ptr cint, y: ptr cint, comp: ptr int32, req_comp: int32): ptr cuchar {.importc: "stbi_load_from_file".}
proc load_16*(filename: cstring, x: ptr cint, y: ptr cint, comp: ptr int32, req_comp: int32): ptr cuchar {.importc: "stbi_load_16",cdecl.}

proc loadf*(filename: cstring, x: ptr cint, y: ptr cint, comp: ptr int32, req_comp: int32): ptr cfloat {.importc: "stbi_loadf".}
proc loadf_from_memory*(buffer: ptr cuchar, x: ptr cint, y: ptr cint, comp: ptr int32, req_comp: int32): ptr cfloat {.importc: "stbi_loadf_from_memory".}
proc loadf_from_callbacks*(clbk: ptr IoCallbacks, user: pointer, x: ptr cint, y: ptr cint, comp: ptr int32, req_comp: int32): ptr cfloat {.importc: "stbi_loadf_from_callbacks".}
proc loadf_from_file*(f: ptr FileHandle, x: ptr cint, y: ptr cint, comp: ptr int32, req_comp: int32): ptr cfloat {.importc: "stbi_loadf_from_file".}
...
proc is_16_bit_from_memory*(buffer: ptr cuchar; len: int32): int32 {.importc: "stbi_is_16_bit_from_memory".}
...
proc info*(filename: cstring, x: ptr cint, y: ptr cint, comp: ptr int32): cint {.importc: "stbi_info".}
proc info_from_memory*(buffer: ptr cuchar, len: cint, x: ptr cint, y: ptr cint, comp: ptr int32): cint {.importc: "stbi_info_from_memory".}
proc info_from_callbacks*(clbk: ptr IoCallbacks, user: pointer, x: ptr cint, y: ptr cint, comp: ptr int32): cint {.importc: "stbi_info_from_callbacks".}
proc info_from_file*(f: ptr FileHandle, x: ptr cint, y: ptr cint, comp: ptr int32): cint {.importc: "info_from_file".}
